        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4 border-t space-y-3" style={{ borderColor: 'var(--border-light)' }}>
              <div className="flex items-center justify-between">
                <div>
                  <label className="text-xs font-semibold uppercase tracking-wider flex items-center gap-2" style={{ color: 'var(--text-secondary)' }}>
                    ...
                    <span>Private Poll (Secret Link Only)</span>
                  </label>
                  <p className="text-[11px] text-slate-400 mt-0.5">Private polls won't be listed in Explore or Public feeds.</p>
                </div>
                ...
                <button
                  ...
                  className={`w-12 h-6 flex items-center rounded-full p-1 transition-colors duration-300 cursor-pointer ${
                    isPrivate ? 'bg-purple-600' : 'bg-slate-300'
                  }`}
                >
                  <div
              ...
              {isPrivate && (
                <div className="pt-2 animate-fade-in bg-purple-50/50 p-4 rounded-2xl border border-purple-100 space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-purple-200 text-xs font-mono font-bold outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 bg-white text-purple-950"
                  />
                  <p className="text-[10px] text-purple-700/70">
                    Voters opening your link will need to enter this 4-digit PIN code to view options and vote.
                  </p>
                </div>
              )}
            </div>
