...
export default function Register() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Start registration
      const registrationResponse = await startRegistration({ optionsJSON: regOptions });
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[20%] right-[-10%] w-[500px] h-[500px] bg-blue-100/50 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] bg-blue-50/60 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="auth-box w-full max-w-[420px] relative z-10">
        ...
        <div className="bg-white/80 backdrop-blur-2xl rounded-[2.5rem] p-10 shadow-[0_8px_40px_rgb(0,0,0,0.04)] border border-white">
          ...
          <div className="text-center mb-10 auth-element">
            <h1 className="font-serif text-4xl font-bold text-slate-900 mb-4 tracking-tight">
              Create an Account.
            </h1>
            <p className="text-slate-500 text-sm font-light">
              Join us using a secure, passwordless biometric passkey.
            </p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-6 auth-element">
            <div>
              <label htmlFor="username" className="block text-[11px] font-bold uppercase tracking-widest text-slate-400 mb-2 pl-1">
                Username
              </label>
              <input
                id="username"
                ...
                className="w-full px-5 py-4 rounded-2xl border border-slate-100 bg-slate-50 text-base transition-all outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-400 focus:bg-white"
                required
              />
            </div>
          ...
          <div className="relative text-center my-8 auth-element">
          ...
          <div className="grid grid-cols-2 gap-4 auth-element">
            <button
              type="button"
